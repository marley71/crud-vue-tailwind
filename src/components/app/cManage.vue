...
export default {
  ...
  methods: {
    _dynamicData (conf) {
      ...
      showInsert() {
          this.jQe('[c-edit-area]').removeClass('hidden');
          this.jQe('[c-list-container]').addClass('hidden');
          this.jQe('[c-search-container]').addClass('hidden');
      },
    showEdit() {
        this.jQe('[c-edit-area]').removeClass('hidden');
        this.jQe('[c-list-container]').addClass('hidden');
      ...
      showList() {
          this.jQe('[c-edit-area]').addClass('hidden');
          this.jQe('[c-list-container]').removeClass('hidden');
          this.jQe('[c-search-container]').removeClass('hidden');
      }
